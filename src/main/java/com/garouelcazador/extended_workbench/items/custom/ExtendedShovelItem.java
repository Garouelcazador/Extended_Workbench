...
public class ExtendedShovelItem extends ShovelItem {
    private final float toolRange;
    private final Multimap<Attribute, AttributeModifier> defaultModifiers;

    public ExtendedShovelItem(Tier tier, float attackDamage, float attackSpeed, float toolRange, Properties properties) {
