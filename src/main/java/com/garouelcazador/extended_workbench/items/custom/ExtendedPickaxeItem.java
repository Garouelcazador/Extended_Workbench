...
public class ExtendedPickaxeItem extends PickaxeItem {
    private final float toolRange;
    private final Multimap<Attribute, AttributeModifier> defaultModifiers;

    public ExtendedPickaxeItem(Tier tier, int attackDamage, float attackSpeed, float toolRange, Properties properties) {
